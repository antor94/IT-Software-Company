        ...
        <div className="container">
            <div className=" award-row">
                ...
                <div>
                    ...
                    <div className='w-[526px]'><p className='text-[18px] font-normal font-main text-primary'>We create diverse, complex, web and mobile solutions for any business need. With us you get quality software and perfect service every time.</p></div>
